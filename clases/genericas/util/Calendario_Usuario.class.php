<? class Calendario_Usuario{
	...
	//constructor
	function Calendario_Usuario($interfase=""){
...
function crearEstilos(){
	...
	echo ".stCerrar{border-left:1px solid #ffb400;background-color:#ffb400;font-size:7pt;color:#006194;cursor:pointer;}\n";
	...
	echo ".stDomingo{border:1px solid #FBFBFC;background-color:#006194;font-size:7pt;color:#FFFFFF;}\n";
	echo ".stHoy{border:1px solid #FBFBFC;background-color:#006194;font-size:7pt;color:#FFFFFF;}\n";
...
function mostrarCalendario(){
	...
	echo "<tr><td style=\"background-color:#006194;color:#ffffff\">";
	echo "<b>Seleccione la fecha</b></td><td width=20 align=\"center\" class=\"stCerrar\" onClick=\"".$cerrar."\">";
	echo "X</td></tr></table>";
	echo "<table width=192 cellspacing=0 cellpadding=0 border=0 class=\"stTabla\"><tr><td colspan=7 align=center>";
	echo "<table width=100% height=23 cellspacing=0 cellpadding=0 border=0><tr><td align=center width=27 class=\"stManejador\">";
	...
	echo "<a class=\"hrefManejador\" href=\"".$_SERVER['PHP_SELF']."?".$this->persiste."nm=".$mes_siguiente."&na=".$ano_siguiente."\" title=\"Siguiente\">&gt;&gt;</a></td></tr></table></td></tr>";
	echo "	<tr>

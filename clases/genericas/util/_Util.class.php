...
class Util{
	...
	function salidaTexto($str){
		...
		$str = ereg_replace($strComilla,"&#8221",$str);
		$str = stripslashes($str);
		return $str;
	}
	function antiComilla($str){
		$comilla = chr(39);
		$strEnter = ereg_replace($comilla, "\\".chr(39), $str);
		return $strEnter;
	}
	...
	function quitarFormato($texto){
		$patron0 = "</FONT>";
		$texto = ereg_replace($patron0,"",$texto);
		$patron1 = "<FONT([^>]+)>";
		$texto = ereg_replace($patron1,"",$texto);
		$patron2 = "</P>";
		$texto = ereg_replace($patron2,"<br />",$texto);
		$patron3 = "<P([^>]+)>";
		$texto = ereg_replace($patron3,"",$texto);
		return $texto;
	}
...
= explode(" ",$coincidencias[1][$a]);
			...
			$rem.="\">";
			$str = eregi_replace($coincidencias[0][$a],$rem,$str);
		}
		$patron2 = "</P>";
		$str =ereg_replace($patron2,"<br />",$str);
		$patron3 = "<P([^>]+)>";
		$str =ereg_replace($patron3,"",$str);
		$patron5 = "<P>";
		$str =ereg_replace($patron5,"",$str);
		$str = eregi_replace("&apos;","'",$str);
		$str = ereg_replace("<B>","<b>",$str);
		$str = ereg_replace("</B>","</b>",$str);
		$str = ereg_replace("<U>","<u>",$str);
		$str = ereg_replace("</U>","</u>",$str);
		$str = ereg_replace("<A HREF=","<a href=",$str);
		$str = ereg_replace("</A>","</a>",$str);
		$str = ereg_replace(" TARGET="," target=",$str);
		$str = ereg_replace("<LI>","<li>",$str);
		$str = ereg_replace("</LI>","</li>",$str);
...
= explode(" ",$coincidencias[1][$a]);
			for($i=0;$i<count($ar);$i++){
				...
				switch(strtoupper($ar2[0])){
					...
					break;
					case "FACE":
						$rem.="font-family:".eregi_replace("\"","",$ar2[1]).";";
					break;
					case "SIZE":
						$rem.="font-size:".eregi_replace("\"","",$ar2[1])."px;";
					break;
				}
			}
			$rem.="\">";
...
= explode(" ",$coincidenciasp[1][$a]);
			...
			$rem.="\">";
			$str = eregi_replace($coincidenciasp[0][$a],$rem,$str);
		}
		$patron2 = "</P>";
		$str =ereg_replace($patron2,"</p>",$str);
		$str = eregi_replace("&apos;","'",$str);
		$str =ereg_replace("<P>","<p>",$str);
		$str = ereg_replace("<B>","<b>",$str);
		$str = ereg_replace("</B>","</b>",$str);
		$str = ereg_replace("<U>","<u>",$str);
		$str = ereg_replace("</U>","</u>",$str);
		$str = ereg_replace("<I>","<i>",$str);
		$str = ereg_replace("</I>","</i>",$str);
		$str = ereg_replace("<A HREF=","<a href=",$str);
		$str = ereg_replace("</A>","</a>",$str);
		$str = ereg_replace(" TARGET="," target=",$str);
	...
	function verificarAtaque($valor,$tipo=0,$maximoX=-1,$maximoY=-1,$maximoCaracteres=-1){
		if($tipo==1){
			...
			if($tipo==2){
				...
				$valor = eregi_replace("<( *)a(.*) href=\\\"javascript:(.*)>(.*)</a>","",$valor);
				$valor = eregi_replace("<( *)a(.*) href=\\'javascript:(.*)>(.*)</a>","",$valor);
				$valor = eregi_replace("(<.*) onclick=\\\".*\\\"","\\1",$valor);				
...
= explode("\n",$valor);
	...
	function convertirFecha($dateFecha){// string
			if($dateFecha!=""){
				list($strAnio,$strMes,$strDia)=split("-", $dateFecha);
